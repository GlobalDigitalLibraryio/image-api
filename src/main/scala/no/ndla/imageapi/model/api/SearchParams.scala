...
case class SearchParams(@(ApiModelProperty@field)(description = "Return only images with titles, alt-texts or tags matching the specified query.") query: Option[String],
                        ...
                        @(ApiModelProperty@field)(description = "The BCP-47 language code describing language used in query-params") language: Option[String],
                        ...
                        @(ApiModelProperty@field)(description = """The sorting used on results.
                                                                   The following are supported: relevance, -relevance, title, -title, lastUpdated, -lastUpdated, id, -id.
                                                                   Default is by -relevance (desc) when query is set, and title (asc) when query is empty.""") sort: Option[String],
